...
Private Type GdiplusStartupInput
    ...
    SuppressBackVungDatVangThread    As Long
...
Private Declare Function GdipCreateHBITMAPFromBitmap Lib "gdiplus" (ByVal BITMAP As Long, ByRef hbmReturn As Long, ByVal BackVungDatVang As Long) As Long
Private Declare Function GdipDisposeImage Lib "gdiplus" (ByVal Image As Long) As Long
Private Declare Function GdipCreateFromHDC Lib "gdiplus" (ByVal hdc As Long, hGraphics As Long) As Long
Private Declare Function GdipDeleteGraphics Lib "gdiplus" (ByVal hGraphics As Long) As Long
Private Declare Function GdipDrawImageRectRectI Lib "gdiplus" (ByVal hGraphics As Long, ByVal hImage As Long, ByVal dstX As Long, ByVal dstY As Long, ByVal dstWidth As Long, ByVal dstHeight As Long, ByVal SrcX As Long, ByVal SrcY As Long, ByVal srcWidth As Long, ByVal srcHeight As Long, ByVal srunit As Long, Optional ByVal imageAttributes As Long = 0, Optional ByVal Callback As Long = 0, Optional ByVal CallbackData As Long = 0) As Long
Private Declare Function GdipGetImageBounds Lib "GdiPlus.dll" (ByVal nImage As Long, srcRect As RECTF, srunit As Long) As Long
...
Private Sub DrawProgress(Max As Long, Value As Long)
    ...
    Dim hBackVungDatVangBrush As Long, hProgressBrush As Long
    ...
    hBackVungDatVangBrush = CreateSolidBrush(&HCC9999)
    ...
    With UserControl
        ...
        FillRect .hdc, Rec, hBackVungDatVangBrush
    ...
    DeleteObject hBackVungDatVangBrush
